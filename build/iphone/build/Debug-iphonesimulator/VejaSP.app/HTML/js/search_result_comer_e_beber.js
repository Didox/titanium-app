...
Models.SearchResult = function(rawData) {
  ...
  this.indicado          = true ? typeof(rawData['anos_indicado_comer_beber-meta']) != "undefined" && rawData['anos_indicado_comer_beber-meta'].indexOf(ano_comer_e_beber) != -1 : false;
  this.vencedor          = true ? typeof(rawData['anos_vencedor_comer_beber-meta']) != "undefined" && rawData['anos_vencedor_comer_beber-meta'].indexOf(ano_comer_e_beber) != -1 : false;
