...
// in simulator we redefine to format for VejaSP Developer console
...
{\
	NSString * exceptionName = [@"org.vejasp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.vejasp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVejaSPNativeItemNone = -1, 
	UIVejaSPNativeItemSpinner = -2,
	UIVejaSPNativeItemProgressBar = -3,
	
	UIVejaSPNativeItemSlider = -4,
	UIVejaSPNativeItemSwitch = -5,
	UIVejaSPNativeItemMultiButton = -6,
	UIVejaSPNativeItemSegmented = -7,
	
	UIVejaSPNativeItemTextView = -8,
	UIVejaSPNativeItemTextField = -9,
	UIVejaSPNativeItemSearchBar = -10,
	
	UIVejaSPNativeItemPicker = -11,
	UIVejaSPNativeItemDatePicker = -12,
	
	UIVejaSPNativeItemInfoLight = -13,
	UIVejaSPNativeItemInfoDark = -14,
	
	UIVejaSPNativeItemDisclosure = -15,
	
	UIVejaSPNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all VejaSP instances of
